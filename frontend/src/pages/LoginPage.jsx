        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen ">
                <div className="bg-blue-600 text-white  p-15">
                    <div className="text-3xl font-bold tracking-tight text-left text-white select-none">
                        task<span className="text-blue-200">pulse</span>
                    </div>
          ...
          <div className="flex border rounded-lg overflow-hidden w-fit mb-6">
            <Link to="/signup" className=" btn px-5 py-2 text-slate-500  text-sm">
              Register
            </Link>

            <Link to="/login" className=" btn px-5 py-2 bg-blue-600 text-white text-sm ">
              Log in
            </Link>
          </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            className="btn w-full bg-blue-600 text-white font-medium rounded-lg mt-5 py-3 flex items-center justify-center gap-3 hover:bg-blue-700 transition border-none"
                        >
                            Log in
                        </button>
                    </form>
